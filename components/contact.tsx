...
export default function ContactPage() {
  ...
  return (
    <div
      id="contact"
      className="justify-center text-left text-wrap rounded-lg transition-colors pt-28 md:pt-32 pb-20 bg-transparent"
    >
      <div className="justify-center">
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="z-10 p-6 rounded-lg shadow-sm max-w-md w-full mx-auto transition-all duration-300 hover:border-primary"
        >
          <motion.h1
          ...
          <motion.div className="space-y-6" variants={itemVariants}>
            <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
              <div
                ...
                className="flex items-center justify-between p-4 text-base rounded-lg hover:text-zinc-600 transition duration-300 cursor-pointer border border-transparent hover:border-primary group"
              >
            ...
            <Link
              ...
              className="flex items-center justify-between p-4 text-base rounded-lg hover:text-zinc-600 transition duration-300 border border-transparent hover:border-primary group"
            >
              <div className="flex items-center space-x-3">
